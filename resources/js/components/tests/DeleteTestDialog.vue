...
import TestsController from '@/actions/App/Http/Controllers/School/TestsController';
            ...
            >
                <DialogHeader class="space-y-2">
                    ...
                    <DialogDescription class="leading-relaxed">
                        Você está prestes a excluir a prova
                ...
                >
                    ...
                    <p class="mt-1 opacity-90">
                        Recomendamos confirmar se esta prova não está em uso
                        em outras rotinas do sistema.
                    </p>
                    <InputError class="mt-2" :message="errors.test" />
                </div>
