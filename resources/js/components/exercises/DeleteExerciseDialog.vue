...
import ExercisesController from '@/actions/App/Http/Controllers/School/ExercisesController';
...
<template>
    <Dialog>
        ...
        <DialogContent class="sm:max-w-lg">
            <Form
                v-bind="
                    ExercisesController.destroy.form({
            ...
            >
                <DialogHeader class="space-y-2">
                    ...
                    <DialogDescription class="leading-relaxed">
                        Você está prestes a excluir o exercício
                ...
                >
                    ...
                    <p class="mt-1 opacity-90">
                        Recomendamos confirmar se este exercício não está em uso
                        em outras rotinas do sistema.
                    </p>
                    <InputError class="mt-2" :message="errors.exercise" />
                </div>
